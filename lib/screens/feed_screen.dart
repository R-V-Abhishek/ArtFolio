...
List<Post> _localDemoPosts() {
  ...
  return [
    Post(
      ...
      userId: 'local',
      type: PostType.image,
      mediaUrl: 'https://picsum.photos/seed/local1/640/800',
    ...
    Post(
      ...
      mediaUrls: const [
        'https://picsum.photos/seed/local2a/800/800',
        'https://picsum.photos/seed/local2b/801/800',
        'https://picsum.photos/seed/local2c/802/800',
      ],
    ...
    Post(
      ...
      thumbnailUrl: 'https://picsum.photos/seed/local3thumb/640/360',
